...
public class Constants {
    ...
    public static class Blocks {
        ...
        public static final String MOON_DUNGEON_BRICKS_BLOCK = "moon_dungeon_bricks";
        public static final String MARS_SURFACE_ROCK_BLOCK = "mars_surface_rock";
        public static final String MARS_SUB_SURFACE_ROCK_BLOCK = "mars_sub_surface_rock";
        public static final String MARS_STONE = "mars_stone";
        public static final String MARS_COBBLESTONE = "mars_cobblestone";
        public static final String MARS_DUNGEON_BRICKS_BLOCK = "mars_dungeon_bricks";
        public static final String DENSE_ICE_BLOCK = "dense_ice";
        public static final String ASTEROID_ROCK_BLOCK = "asteroid_rock";
        public static final String ASTEROID_ROCK_BLOCK_1 = "asteroid_rock_block_1";
        public static final String ASTEROID_ROCK_BLOCK_2 = "asteroid_rock_block_2";
        public static final String VENUS_ROCK_BLOCK = "venus_rock";
        public static final String VENUS_ROCK_BLOCK_1 = "venus_rock_block_1";
        public static final String VENUS_ROCK_BLOCK_2 = "venus_rock_block_2";
        public static final String VENUS_ROCK_BLOCK_3 = "venus_rock_block_3";
        public static final String VENUS_ROCK_BLOCK_SCORCHED = "venus_rock_block_scorched";
        public static final String VOLCANIC_ROCK_BLOCK = "volcanic_rock";
        public static final String SCORCHED_ROCK_BLOCK = "scorched_rock";
        public static final String PUMICE_BLOCK = "pumice";
        public static final String VAPOR_SPOUT_BLOCK = "vapor_spout";

        // Ore
        public static final String ALUMINUM_ORE_BLOCK = "aluminum_ore";
        public static final String ASTEROID_ALUMINUM_ORE_BLOCK = "asteroid_aluminum_ore";
        public static final String CHEESE_ORE_BLOCK = "cheese_ore";
        public static final String COPPER_ORE_BLOCK = "copper_ore";
        public static final String MOON_COPPER_ORE_BLOCK = "moon_copper_ore";
        public static final String MARS_COPPER_ORE_BLOCK = "mars_copper_ore";
        public static final String DESH_ORE_BLOCK = "desh_ore";
        public static final String ILMENITE_ORE_BLOCK = "ilmenite_ore";
        public static final String MARS_IRON_ORE_BLOCK = "mars_iron_ore";
        public static final String ASTEROID_IRON_ORE_BLOCK = "asteroid_iron_ore";
        public static final String SILICON_ORE_BLOCK = "silicon_ore";
        public static final String TIN_ORE_BLOCK = "tin_ore";
        public static final String MOON_TIN_ORE_BLOCK = "moon_tin_ore";
        public static final String MARS_TIN_ORE_BLOCK = "mars_tin_ore";
        public static final String GALENA_ORE_BLOCK = "galena_ore";
        ...
        public static final String DARK_DECORATION_BLOCK = "dark_decoration";
        public static final String GRATING_BLOCK = "grating";
        ...
        public static final String VACUUM_GLASS_BLOCK = "vacuum_glass";
        public static final String VACUUM_GLASS_BLOCK_CLEAR = "vacuum_glass_clear";
        public static final String VACUUM_GLASS_BLOCK_TIN = "vacuum_glass_tin";
        public static final String VACUUM_GLASS_BLOCK_STRONG = "vacuum_glass_strong";
        public static final String WALKWAY_BLOCK = "walkway";
        ...
        public static final String CAVERNOUS_VINE_BLOCK = "cavernous_vine";
        public static final String POISONOUS_CAVERNOUS_VINE_BLOCK = "poisonous_cavernous_vine";
        public static final String MOON_BERRY_BUSH_BLOCK = "moon_berry_bush";
        public static final String WEB_TORCH = "web_torch";
        public static final String FALLEN_METEOR = "fallen_meteor";
        public static final String SLIMELING_EGG_BLOCK = "slimeling_egg";
        public static final String CREEPER_EGG_BLOCK = "creeper_egg";

        // Special
        public static final String PARACHEST_BLOCK = "parachest";
        public static final String SPACE_STATION_ARRIVAL_BLOCK = "space_station_arrival";
        ...
        // Liquids
        public static final String FUEL_BLOCK = "fuel";
        public static final String CRUDE_OIL_BLOCK = "crude_oil";

        // Machines
        public static final String CIRCUIT_FABRICATOR_BLOCK = "circuit_fabricator";
        public static final String COMPRESSOR_BLOCK = "compressor";
        public static final String ELECTRIC_COMPRESSOR_BLOCK = "electric_compressor";
        public static final String ELECTRIC_FURNACE_BLOCK = "electric_furnace";
        public static final String ELECTRIC_ARC_FURNACE_BLOCK = "electric_arc_furnace";
        public static final String OXYGEN_BUBBLE_DISTRIBUTOR_BLOCK = "oxygen_bubble_distributor";
        public static final String OXYGEN_COLLECTOR_BLOCK = "oxygen_collector";
        public static final String OXYGEN_COMPRESSOR_BLOCK = "oxygen_compressor";
        public static final String OXYGEN_DECOMPRESSOR_BLOCK = "oxygen_decompressor";
        public static final String OXYGEN_DETECTOR_BLOCK = "oxygen_detector";
        public static final String OXYGEN_SEALER_BLOCK = "oxygen_sealer";
        public static final String OXYGEN_PIPE_BLOCK = "oxygen_pipe";
        public static final String REFINERY_BLOCK = "refinery";
        public static final String TERRAFORMER_BLOCK = "terraformer";
        public static final String DECONSTRUCTOR_BLOCK = "deconstructor";
        public static final String WATER_ELECTROLYZER_BLOCK = "water_electrolyzer";
        public static final String METHANE_SYNTHESIZIER_BLOCK = "methane_synthesizer";
        public static final String GAS_LIQUEFIER_BLOCK = "gas_liquefier";

        // Pad Blocks
        public static final String BUGGY_FUELING_PAD_BLOCK = "buggy_fueling";
        public static final String ROCKET_LAUNCH_PAD_BLOCK = "rocket_launch_pad";
        public static final String FUEL_LOADER_BLOCK = "fuel_loader";
        public static final String CARGO_LOADER_BLOCK = "cargo_loader";
        public static final String CARGO_UNLOADER_BLOCK = "cargo_unloader";
        public static final String LAUNCH_CONTROLLER_BLOCK = "launch_controller";

        // Space Base
        public static final String HYDRAULIC_PLATFORM_BLOCK = "hydraulic_platform";
        public static final String MAGNETIC_CRAFTING_TABLE_BLOCK = "magnetic_crafting_table";
        public static final String NASA_WORKBENCH_BLOCK = "nasa_workbench";
        public static final String AIR_LOCK_FRAME_BLOCK = "air_lock_frame";
        public static final String AIR_LOCK_CONTROLLER_BLOCK = "air_lock_controller";
        public static final String AIR_LOCK_SEAL_BLOCK = "air_lock_seal";
        public static final String CHROMATIC_APPLICATOR_BLOCK = "chromatic_applicator";
        public static final String DISPLAY_SCREEN_BLOCK = "display_screen";
        public static final String TELEMETRY_UNIT_BLOCK = "telemetry_unit";
        public static final String COMMUNICATIONS_DISH_BLOCK = "communications_dish";
        public static final String ARC_LAMP_BLOCK = "arc_lamp";
        public static final String SPIN_THRUSTER_BLOCK = "spin_thruster";
        public static final String CRYOGENIC_CHAMBER_BLOCK = "cryogenic_chamber";
        public static final String ASTRO_MINER_BASE_BLOCK = "astro_miner_base";
        public static final String SHORT_RANGE_TELEPAD_BLOCK = "short_range_telepad";

        // Power
        public static final String BASIC_SOLAR_PANEL_BLOCK = "basic_solar_panel";
        public static final String BASIC_SOLAR_PANEL_PART_BLOCK = "basic_solar_panel_part";
        public static final String ADVANCED_SOLAR_PANEL_BLOCK = "advanced_solar_panel";
        public static final String COAL_GENERATOR_BLOCK = "coal_generator";
        public static final String GEOTHERMAL_GENERATOR_BLOCK = "geothermal_generator";
        public static final String ENERGY_STORAGE_MODULE_BLOCK = "energy_storage_module";
        public static final String ENERGY_STORAGE_CLUSTER_BLOCK = "energy_storage_cluster";
        public static final String ALUMINUM_WIRE_BLOCK = "aluminum_wire";
        public static final String HEAVY_ALUMINUM_WIRE_BLOCK = "heavy_aluminum_wire";
        public static final String SWITCHABLE_ALUMINUM_WIRE_BLOCK = "switchable_aluminum_wire";
        public static final String SEALABLE_ALUMINUM_WIRE_BLOCK = "sealable_aluminum_wire";
        public static final String HEAVY_SEALABLE_ALUMINUM_WIRE_BLOCK = "heavy_sealable_aluminum_wire";
        public static final String BEAM_REFLECTOR_BLOCK = "beam_reflector";
        public static final String BEAM_RECEIVER_BLOCK = "beam_receiver";
        public static final String SOLAR_ARRAY_MODULE_BLOCK = "solar_array_module";
    }
