...
import io.github.teamgalacticraft.galacticraft.blocks.machines.electriccompressor.ElectricCompressorBlock;
...
public class GalacticraftBlocks {
    ...
    public static final Block MOON_DIRT_BLOCK = new Block(FabricBlockSettings.of(Material.EARTH, MaterialColor.LIGHT_GRAY).strength(0.5F, 0.5F).sounds(BlockSoundGroup.GRAVEL).build());
    ...
    public static final Block GRATING_BLOCK = new GratingBlock(FabricBlockSettings.of(Material.METAL, MaterialColor.STONE).strength(2.5f, 6.0f).sounds(BlockSoundGroup.METAL).build());
    public static final Block ALUMINUM_WIRE_BLOCK = new AluminumWireBlock(FabricBlockSettings.copy(Blocks.WHITE_WOOL).build());
    public static final Block OXYGEN_PIPE_BLOCK = new Block(FabricBlockSettings.of(Material.WOOL).breakByHand(true).sounds(BlockSoundGroup.GLASS).build());
    ...
    public static final Block VACUUM_GLASS_BLOCK = new VacuumGlassBlock(FabricBlockSettings.of(Material.GLASS).sounds(BlockSoundGroup.GLASS).build());
    public static final Block VACUUM_GLASS_BLOCK_CLEAR = new VacuumGlassBlock(FabricBlockSettings.of(Material.GLASS).sounds(BlockSoundGroup.GLASS).build());
    public static final Block VACUUM_GLASS_BLOCK_TIN = new VacuumGlassBlock(FabricBlockSettings.of(Material.GLASS).sounds(BlockSoundGroup.GLASS).build());
    public static final Block VACUUM_GLASS_BLOCK_STRONG = new VacuumGlassBlock(FabricBlockSettings.of(Material.GLASS).sounds(BlockSoundGroup.GLASS).build());
    public static final Block WALKWAY_BLOCK = new Block(FabricBlockSettings.of(Material.METAL).strength(5.0f, 5.0f).sounds(BlockSoundGroup.METAL).build());
    public static final Block WALKWAY_BLOCK_WIRE = new Block(FabricBlockSettings.of(Material.METAL).strength(5.0f, 5.0f).sounds(BlockSoundGroup.METAL).build());
    public static final Block WALKWAY_BLOCK_PIPE = new Block(FabricBlockSettings.of(Material.METAL).strength(5.0f, 5.0f).sounds(BlockSoundGroup.METAL).build());
    ...
    public static final Block COPPER_BLOCK = new Block(FabricBlockSettings.of(Material.METAL).strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).build());
    public static final Block TIN_BLOCK = new Block(FabricBlockSettings.of(Material.METAL).strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).build());
    public static final Block ALUMINUM_BLOCK = new Block(FabricBlockSettings.of(Material.METAL).strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).build());
    public static final Block SILICON_BLOCK = new Block(FabricBlockSettings.of(Material.METAL).strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).build());
    public static final Block SOLID_METEORIC_IRON_BLOCK = new Block(FabricBlockSettings.of(Material.METAL).strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).build());
    public static final Block DESH_BLOCK = new Block(FabricBlockSettings.of(Material.METAL).strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).build());
    public static final Block TITANIUM_BLOCK = new Block(FabricBlockSettings.of(Material.METAL).strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).build());
    public static final Block LEAD_BLOCK = new Block(FabricBlockSettings.of(Material.METAL).strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).build());
    public static final Block UNLIT_TORCH_BLOCK = new UnlitTorchBlock(FabricBlockSettings.copy(Blocks.TORCH).lightLevel(0).build());
    public static final Block GLOWSTONE_TORCH_BLOCK = new GlowstoneTorchBlock(FabricBlockSettings.copy(Blocks.TORCH).lightLevel(15).sounds(BlockSoundGroup.WOOD).build());
    public static final Block GLOWSTONE_WALL_TORCH_BLOCK = new GlowstoneWallTorchBlock(FabricBlockSettings.copy(Blocks.TORCH).lightLevel(15).dropsLike(GLOWSTONE_TORCH_BLOCK).sounds(BlockSoundGroup.WOOD).build());
    ...
    public static final Block ELECTRIC_COMPRESSOR_BLOCK = new ElectricCompressorBlock(FabricBlockSettings.of(Material.METAL).sounds(BlockSoundGroup.METAL).build());
    public static final Block COAL_GENERATOR_BLOCK = new CoalGeneratorBlock(FabricBlockSettings.of(Material.METAL).sounds(BlockSoundGroup.METAL).build());
    ...
    public static void register() {
        ...
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.MOON_DUNGEON_BRICKS), MOON_DUNGEON_BRICKS_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.MARS_SURFACE_ROCK), MARS_SURFACE_ROCK_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.MARS_SUB_SURFACE_ROCK), MARS_SUB_SURFACE_ROCK_BLOCK);
        ...
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.MARS_DUNGEON_BRICKS), MARS_DUNGEON_BRICKS_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.DENSE_ICE), DENSE_ICE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.ASTEROID_ROCK), ASTEROID_ROCK_BLOCK);
        ...
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.VENUS_ROCK), VENUS_ROCK_BLOCK);
        ...
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.VOLCANIC_ROCK), VOLCANIC_ROCK_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.SCORCHED_ROCK), SCORCHED_ROCK_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.PUMICE), PUMICE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.VAPOR_SPOUT), VAPOR_SPOUT_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.TIN_DECORATION), TIN_DECORATION_BLOCK);
        ...
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.COPPER_ORE), COPPER_ORE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.TIN_ORE), TIN_ORE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.ALUMINUM_ORE), ALUMINUM_ORE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.SILICON_ORE), SILICON_ORE_BLOCK);
        ...
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.ASTEROID_ALUMINUM_ORE), ASTEROID_ALUMINUM_ORE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.CHEESE_ORE), CHEESE_ORE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.MOON_COPPER_ORE), MOON_COPPER_ORE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.MARS_COPPER_ORE), MARS_COPPER_ORE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.DESH_ORE), DESH_ORE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.ILMENITE_ORE), ILMENITE_ORE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.MARS_IRON_ORE), MARS_IRON_ORE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.ASTEROID_IRON_ORE), ASTEROID_IRON_ORE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.MARS_TIN_ORE), MARS_TIN_ORE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.MOON_TIN_ORE), MOON_TIN_ORE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.GALENA_ORE), GALENA_ORE_BLOCK);
        ...
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.DARK_DECORATION), DARK_DECORATION_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.GRATING), GRATING_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.ALUMINUM_WIRE), ALUMINUM_WIRE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.OXYGEN_PIPE), OXYGEN_PIPE_BLOCK);
        ...
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.VACUUM_GLASS), VACUUM_GLASS_BLOCK);
        ...
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.WALKWAY), WALKWAY_BLOCK);
        ...
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.MARS_COBBLESTONE_SLAB), MARS_COBBLESTONE_SLAB_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.MARS_DUNGEON_BRICKS_SLAB), MARS_DUNGEON_BRICKS_SLAB_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.MOON_DUNGEON_BRICKS_SLAB), MOON_DUNGEON_BRICKS_SLAB_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.MOON_ROCK_SLAB), MOON_ROCK_SLAB_BLOCK);
        ...
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.CHEESE), CHEESE_BLOCK);
        ...
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.CAVERNOUS_VINE), CAVERNOUS_VINE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.POISONOUS_CAVERNOUS_VINE), POISONOUS_CAVERNOUS_VINE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.MOON_BERRY_BUSH), MOON_BERRY_BUSH_BLOCK);

        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.CRUDE_OIL), CRUDE_OIL_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.FUEL), FUEL_BLOCK);

        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.CIRCUIT_FABRICATOR), CIRCUIT_FABRICATOR_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.COMPRESSOR), COMPRESSOR_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.ELECTRIC_COMPRESSOR), ELECTRIC_COMPRESSOR_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.COAL_GENERATOR), COAL_GENERATOR_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.BASIC_SOLAR_PANEL), BASIC_SOLAR_PANEL_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.BASIC_SOLAR_PANEL_PART), BASIC_SOLAR_PANEL_PART_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.ENERGY_STORAGE_MODULE), ENERGY_STORAGE_MODULE_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(Constants.MOD_ID, Constants.Blocks.OXYGEN_COLLECTOR), OXYGEN_COLLECTOR_BLOCK);
