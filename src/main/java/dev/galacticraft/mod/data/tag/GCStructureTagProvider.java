...
public class GCStructureTagProvider
        extends FabricTagProvider<Structure> {

    public GCStructureTagProvider(
    ...
    protected void addTags(
        ...
        this.getOrCreateTagBuilder(
                GCStructureTags.MOON_RUINS
        ).add(
                GCStructures.Moon.RUINS
        );

        this.getOrCreateTagBuilder(
                GCStructureTags.MOON_DUNGEON
        ).add(
