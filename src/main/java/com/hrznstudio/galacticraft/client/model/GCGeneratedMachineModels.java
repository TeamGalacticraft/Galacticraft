...
public enum GCGeneratedMachineModels implements FabricBakedModel, BakedModel {
    ...
    public static void registerDefaults() {
        ...
        register(GalacticraftBlocks.ENERGY_STORAGE_MODULE, (face, spriteFunction, view, state, pos) -> {
            switch (face) {
                case FRONT:
                case BACK:
                    return spriteFunction.apply(new Identifier(Constants.MOD_ID, "block/energy_storage_module_" + state.get(EnergyStorageModuleBlock.ENERGY_LEVEL)));
                default:
                    return spriteFunction.apply(new Identifier(Constants.MOD_ID, "block/machine"));
            }
        });
        ...
        context.pushTransform(quad -> { //?IT WORKS
            ...
            switch (option) {
                ...
                case FLUID_INPUT:
                    ...
                    break;
                case POWER_INPUT:
                    quad.spriteBake(0, atlas.apply(new Identifier(Constants.MOD_ID, "block/machine_power_input")), MutableQuadView.BAKE_LOCK_UV);
                    break;
                case OXYGEN_INPUT:
                    quad.spriteBake(0, atlas.apply(new Identifier(Constants.MOD_ID, "block/machine_oxygen_input")), MutableQuadView.BAKE_LOCK_UV);
                    break;
                case POWER_OUTPUT:
                    quad.spriteBake(0, atlas.apply(new Identifier(Constants.MOD_ID, "block/machine_power_output")), MutableQuadView.BAKE_LOCK_UV);
                    break;
                case FLUID_OUTPUT:
                    quad.spriteBake(0, atlas.apply(new Identifier(Constants.MOD_ID, "block/machine_fluid_output")), MutableQuadView.BAKE_LOCK_UV);
                    break;
                case OXYGEN_OUTPUT:
    ...
    public Sprite getSprite() {
        ...
        return atlas.apply(new Identifier(Constants.MOD_ID, "block/machine"));
    }
