...
public class RocketParts {
    public static final RocketPart DEFAULT_CONE = Registry.register(Galacticraft.ROCKET_PARTS, new Identifier(Constants.MOD_ID, "default_cone"), RocketPart.ServerBuilder.create()
    ...
    public static final RocketPart DEFAULT_BODY = Registry.register(Galacticraft.ROCKET_PARTS, new Identifier(Constants.MOD_ID, "default_body"), RocketPart.ServerBuilder.create()
    ...
    public static final RocketPart DEFAULT_FIN = Registry.register(Galacticraft.ROCKET_PARTS, new Identifier(Constants.MOD_ID, "default_fin"), RocketPart.ServerBuilder.create()
    ...
    public static final RocketPart NO_BOOSTER = Registry.register(Galacticraft.ROCKET_PARTS, new Identifier(Constants.MOD_ID, "default_booster"), RocketPart.ServerBuilder.create()
    ...
    public static final RocketPart DEFAULT_BOTTOM = Registry.register(Galacticraft.ROCKET_PARTS, new Identifier(Constants.MOD_ID, "default_bottom"), RocketPart.ServerBuilder.create()
    ...
    public static final RocketPart ADVANCED_CONE = Registry.register(Galacticraft.ROCKET_PARTS, new Identifier(Constants.MOD_ID, "advanced_cone"), RocketPart.ServerBuilder.create()
    ...
    public static final RocketPart SLOPED_CONE = Registry.register(Galacticraft.ROCKET_PARTS, new Identifier(Constants.MOD_ID, "sloped_cone"), RocketPart.ServerBuilder.create()
    ...
    public static final RocketPart BOOSTER_TIER_1 = Registry.register(Galacticraft.ROCKET_PARTS, new Identifier(Constants.MOD_ID, "booster_1"), RocketPart.ServerBuilder.create()
    ...
    public static final RocketPart BOOSTER_TIER_2 = Registry.register(Galacticraft.ROCKET_PARTS, new Identifier(Constants.MOD_ID, "booster_2"), RocketPart.ServerBuilder.create()
    ...
    public static final RocketPart NO_UPGRADE = Registry.register(Galacticraft.ROCKET_PARTS, new Identifier(Constants.MOD_ID, "default_upgrade"), RocketPart.ServerBuilder.create()
    ...
    public static final RocketPart STORAGE_UPGRADE = Registry.register(Galacticraft.ROCKET_PARTS, new Identifier(Constants.MOD_ID, "storage_upgrade"), RocketPart.ServerBuilder.create()
