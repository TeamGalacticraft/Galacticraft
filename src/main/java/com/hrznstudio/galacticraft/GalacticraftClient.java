...
public class GalacticraftClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ClientSpriteRegistryCallback.EVENT.register((spriteAtlasTexture, registry) -> registry.register(new Identifier(Constants.MOD_ID, Constants.ScreenTextures.MACHINE_CONFIG_ICONS)));
