 ...
 */
public class EnergyStorageModuleScreen extends ContainerScreen {
...
//        this.containerHeight = 166;
    ...
    public void render(int mouseX, int mouseY, float v) {
        ...
        DrawableUtils.drawCenteredString(this.minecraft.textRenderer, new TranslatableTextComponent("block.galacticraft-rewoven.energy_storage_module").getText(), (this.width / 2), this.top + 5, TextFormat.DARK_GRAY.getColor());
